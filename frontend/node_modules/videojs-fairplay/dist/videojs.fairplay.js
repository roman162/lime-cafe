	...
	var Html5Fairplay = function () {
	  ...
	  (0, _createClass3.default)(Html5Fairplay, [{
	    ...
	    value: function hasProtection() {
	      ...
	      var certificateUrl = _ref3.certificateUrl;
	      var keySystem = _ref3.keySystem;
	      var licenseUrl = _ref3.licenseUrl;
	    ...
	    value: function onCertificateLoad(event, _ref4) {
	      ...
	      var response = _event$target.response;
	      var status = _event$target.status;
	    ...
	    value: function onRequestError(request) {
	      var errorType = arguments.length <= 1 || arguments[1] === undefined ? _errorType2.default.UNKNOWN : arguments[1];
	    ...
	    value: function onLicenseLoad(event) {
	      ...
	      var response = _event$target2.response;
	      var session = _event$target2.session;
	      var status = _event$target2.status;
